...
public class Order {
    ...
    public Order(Long order_id, String first_name, String last_name, String full_name, String order_status, String order_remark, String order_date, String order_price) {
